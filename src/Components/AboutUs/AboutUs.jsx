	...
	return (
		<div className="aboutus">
			<div>
				...
				<span
					style={{ marginLeft: "48rem", display: "flex", marginTop: "-17rem" }}
				>
			...
			<div className="vision">
				<div className="parent">
					<div className="child-one">
						<img
							style={{ width: "100%", height: "5rem", paddingTop: ".625rem" }}
							src={vision}
						></img>
					</div>
			...
			<div className="Smart-steps">
				...
				<div style={{ display: "flex" }}>
					<div className="card-1" style={{ background: "#EC5656" }}>
						<h1>Step 01</h1>
					</div>
					<div className="card-white">
						<BsFillTriangleFill className="icon-one" />
				...
				<br />
				<div style={{ display: "flex" }}>
					<div className="card-2" style={{ background: "#023047" }}>
						<h1>Step 02</h1>
					</div>
					<div className="card-white">
						<BsFillTriangleFill className="icon-two" />
						<p className="paragraph">
				...
				<br />
				<div style={{ display: "flex" }}>
					<div className="card-3" style={{ background: "#F07E7E" }}>
						<h1>Step 03</h1>
					</div>
					<div className="card-white">
						<BsFillTriangleFill className="icon-three" />
						<p className="paragraph">
				...
				<br />
				<div style={{ display: "flex" }}>
					<div className="card-4" style={{ background: "#446677" }}>
						<h1>Step 04</h1>
					</div>
					<div className="card-white">
						<BsFillTriangleFill className="icon-four" />
						<p className="paragraph">
				...
				<br />
				<div style={{ display: "flex" }}>
					<div className="card-5" style={{ background: "#EC5656" }}>
						<h1>Step 05</h1>
					</div>
					<div className="card-white">
						<BsFillTriangleFill className="icon-five" />
						<p className="paragraph">
				...
				<br />
				<div style={{ display: "flex" }}>
					<div className="card-6" style={{ background: "#023047" }}>
						<h1>Step 06</h1>
					</div>
					<div className="card-white">
						<BsFillTriangleFill className="icon-six" />
						<p className="paragraph">
