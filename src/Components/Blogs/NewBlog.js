...
import img from "../../Images/Rectangle 103.svg";
import "./new-blog.css";
const { htmlToText } = require("html-to-text");

export const NewBlog = ({ blog }) => {
	if (blog) {
		var strippedHtml1 = blog.description.replace(/<[^>]+>/g, "");
		var strippedHtml2 = blog.information.replace(/<[^>]+>/g, "");
		const string = blog.information.toString();
